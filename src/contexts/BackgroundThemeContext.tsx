...
const themeColors: Record<BackgroundTheme, {
  ...
  ocean: {
    ...
    codeGreen: "280 100% 70%",
    codeYellow: "300 80% 65%",
    codePurple: "270 80% 70%",
    codeOrange: "290 90% 60%",
    codePink: "320 80% 65%",
    accent: "270 80% 60%",
    ring: "270 100% 60%",
    gradientPrimary: "linear-gradient(135deg, hsl(270 100% 60%) 0%, hsl(300 100% 65%) 100%)",
    shadowGlow: "0 0 40px hsl(270 100% 60% / 0.3)",
  },
};
